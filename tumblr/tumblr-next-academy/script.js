...
const apiKey = "gVoHegHtC0Qbh42xwi0RZ4kssfU0CdA2znGiJ1AiO1pHbbe3Zh";
...
function startGame() {
    ...
    let tagName = ['fruit','Superman','Ultraman','Ninja'];
    ...
    fetch(`https://api.tumblr.com/v2/tagged?tag=${randomTag}&api_key=gVoHegHtC0Qbh42xwi0RZ4kssfU0CdA2znGiJ1AiO1pHbbe3Zh`)
        .then(response => {
